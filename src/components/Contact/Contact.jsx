...
function Contact() {
  return (
    <div className={styles.contatc_wapper}>
      <div className={styles.contact_container}>
        <div className={styles.contact_info}>
            ...
            <p className={styles.contact_phone}><FaPhone /> (+66) 98 555 1234</p>
            <p className={styles.contact_email}><FaEnvelope /> support@site.com</p>
        </div>
